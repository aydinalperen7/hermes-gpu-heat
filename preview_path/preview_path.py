...
def main():
    ...
    parser.add_argument("--samples-per-seg", type=int, default=50,
                        help="Interpolation samples per segment (for visual trace).")
    parser.add_argument("--label-every", type=int, default=50,
                        help="Label every Nth point with index (0 to disable).")
